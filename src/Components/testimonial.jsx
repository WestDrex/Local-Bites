      ...
      <div className="comments">
        <div className="top">
          <div className="text">
            ...
            <p>
              Lorem ipsum dolor sit amet consectetur. Ac volutpat nisl ut leo.
              Et interdum nisi consequat eu
              <br />
              pellentesque sed pharetra morbi. Sed lectus ullamcorper urna in
              egestas. Lorem ipsum dolor
              <br />
              sit amet consectetur. Leo mauris fringilla condimentum et
              suspendisse nisl lacus non.
              <br />
            </p>
            <h4>Read More</h4>
